    ...
    if (resource.type === ResourceType.yarn) {
      return (
        <>
          ...
          <div className={classes.attributeName}>{t('gauge')}</div>
          {resource.gauge ?? <br></br>}

          <div className={classes.attributeName}>{t('skeinWeight')}</div>
          {resource.skeinWeight ?? <br></br>}

          <div className={classes.attributeName}>{t('metersInSkein')}</div>
      ...
      return (
        <>
          ...
          <div className={classes.attributeName}>{t('toolType')}</div>
