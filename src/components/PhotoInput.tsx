...
export const FileInput = () => {
  ...
  return (
    <div className={classes.photosContainer}>
      <ImageList sx={{ width: 900, height: "auto", overflow: "visible" }} cols={4} rowHeight={250} gap={8} className={classes.photos}>
        <ImageListItem className={classes.addPhoto}>
          <Button variant="outlined" component="label" className={classes.btnAddPhoto}>
            ...
            <input hidden accept="image/*" multiple type="file" onChange={handleAddingFile} />
          </Button>
        </ImageListItem>
